...
public class MesangeError extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NO TIENE ACCESO PERMITIDO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MesangeError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MesangeError().setVisible(true);
            }
        });
    }
